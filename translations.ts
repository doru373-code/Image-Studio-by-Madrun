...
export const translations = {
  ...
  ro: {
    ...
    magicRemoveBgDesc: "Izolează subiectul principal și elimină complet culoarea de fundal pentru o transparență totală (PNG).",
    ...
    makeTransparent: "Fundal Transparent",
    styles: {
